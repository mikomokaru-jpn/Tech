...
section.appendChild(setMenu(['lm30', 'tm0', 'bm0'], '/lib/index1.html', '_self', 'アプリケーション / ツール')); 
section.appendChild(setMenu(['lm30', 'tm5', 'bm0'], '/lib/index2.html', '_self', 'オブジェクト一般')); 
...
section.appendChild(setMenu(['lm30', 'tm0', 'bm0'], '/lib/index8.html', '_self', 'アプリケーション')); 
section.appendChild(setMenu(['lm30', 'tm5', 'bm20'], '/lib/index13.html', '_self', '技法')); 
//C#
section.appendChild(setTitle(['lm10', 'tm10', 'bm0'], 'C#')); 
section.appendChild(setMenu(['lm30', 'tm0', 'bm20'], '/lib/index14.html', '_self', 'アプリケーション')); 
//JavaScript/PHP
...
section.appendChild(setMenu(['lm10', 'tm40', 'bm0'], '/lib/indexE1.html', '_self', 'English')); 

section.appendChild(setMenu(['lm10', 'tm40', 'bm0'], 'https://github.com/mikomokaru-jpn/', '_self', 'GitHub')); 
